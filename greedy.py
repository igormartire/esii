        ...
        for i in range(8):
            for j in range(8):
                ...
                if (piece == "r") or (piece == "n") or (piece == "b") or (piece == "q") or (piece == "k") or (piece == "p"):
                    ...
                    new_destinations = possible_moviments.destinations(piece, source, board)
                    ...
                    for k in range(len(new_destinations)):
                        ...
                        move.move(board, source.row, source.column, dest_x, dest_y)

                        evaluation = chessai.evaluation_function(board)
